...
Gem::Specification.new do |s|
  ...
  s.files = ["VERSION.yml", "README.markdown", "lib/commercebank.rb", "lib/commercebank", "lib/commercebank/monkey.rb", "test/monkeypatch_test.rb", "test/test_helper.rb", "test/commerce_bank_client_test.rb"]
  s.has_rdoc = true
